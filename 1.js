...
exports.default = [{
    ...
    media: ['https://res.cloudinary.com/dvv4qgnka/image/upload/v1578084877/SAS/salaverry_cruise_01.jpg', 'https://res.cloudinary.com/dvv4qgnka/image/upload/v1578084877/SAS/salaberry_cruise_02.jpg'],
    price: {
        standard: {
            amount: 85
        }
    ...
    cruisesdates: [{
            ...
            },
            {
                destination: 'SILVER NOVA',
                title: 'Silver Sea',
                date: 'December 21, Jueves.'
            },
            {
                destination: 'SILVER NOVA',
                title: 'Silver Sea',
                date: 'January 14, Sunday 2026.'
            },
            {
                destination: 'NORWEGIAN SUN',
                title: 'Norwegian Cruise',
                date: 'January 15, Monday 2026.'
            },
            {
                destination: 'AZAMARA ONWARD',
                title: 'Azamara Cruises',
                date: 'January 16, Tuesday 2026.'
    }]
}, {
    ...
    media: ['https://res.cloudinary.com/dvv4qgnka/image/upload/v1579147717/SAS/tour-lima-02.jpg', 'https://res.cloudinary.com/dvv4qgnka/image/upload/v1579147717/SAS/tour-lima-03.jpg'],
    price: {
        standard: {
            amount: 85
        }
    ...
    cruisesdates: [
            {destination: "CORAL PRINCESS ", title: "Princess Cruises ", date: "August 27."},
            {destination: "MS ZAANDAM ", title: "Holland America ", date: "October 20."},
            {destination: "MS OOSTERDAM ", title: "Holland America ", date: "November 25."},
            {destination: "SAPPHIRE PRINCESS ", title: "Princess Cruises ", date: "December 13."},
            {destination: "OCEANIA MARINA ", title: "Oceania Cruises ", date: "December 17."},
            {destination: "CELEBRITY ECLIPSE ", title: "Celebrity Cruises ", date: "December 18."},
            {destination: "SILVER NOVA ", title: "Silver Sea ", date: "December 18."},
            {destination: "SEVEN SEAS SPLENDOR ", title: "Regent Seven Seas ", date: "December 19."},
            {destination: "SILVER NOVA ", title: "Silversea ", date: "January 15, 2026"},
            {destination: "NORWEGIAN SUN ", title: "Norwegian Cruise ", date: "January 16, 2026."},
            {destination: "SEABOURN QUEST ", title: "Seabourn ", date: "January 16, 2026."},
            {destination: "AZAMARA ONWARD ", title: "Azamara Cruises ", date: "January 17, 2026."},
            {destination: "SERENADE OF THE SEAS ", title: "Royal Caribbean ", date: "January 29, 2026."},
            {destination: "AMADEA ", title: "Phoenix Reisen ", date: "January 31, 2026."},
            {destination: "COSTA DELIZIOSA ", title: "Costa Cruises ", date: "February 03, 2026."},
            {destination: "NORWEGIAN SUN ", title: "Norwegian Cruise ", date: "February 27, 2026."},
            {destination: "SAPPHIRE PRINCESS ", title: "Princess Cruises ", date: "March 23, 2026."},
            {destination: "MS OOSTERDAM ", title: "Holland America ", date: "March 24, 2026."},
            {destination: "SILVER NOVA ", title: "Silver Sea ", date: "March 30, 2026."},
            {destination: "CELEBRITY ECLIPSE ", title: "Celebrity Cruises ", date: "April 11, 2026."},
            {destination: "AMERA ", title: "Phoenix Reisen ", date: "Abril 12, 2026."},
            {destination: "CORAL PRINCESS ", title: "Princess Cruises ", date: "July 25, 2025."}
    ],
    extraTours: [{
        ...
        subtitle: 'from Callao cruise terminal',
        description: 'You are arriving on a cruise to Lima? we offer deluxe tours according to your time and requirements. Our Special Excursion It will take you to visit the best of Lima. The shore excursions include cars with air-conditioning, professional English speaking tour guides.',
        media: ['https://res.cloudinary.com/dvv4qgnka/image/upload/v1579147716/SAS/tour-lima-04.jpg', 'https://res.cloudinary.com/dvv4qgnka/image/upload/v1579147715/SAS/tour-lima-01.jpg'],
        price: {
            standard: {
                amount: 75
            }
    ...
    cruisesdates: [
            ...
            {destination: "MS ZAANDAM ", title: "Holland America ", date: "October 22."},
            {destination: "MS OOSTERDAM ", title: "Holland America ", date: "November 28."},
            {destination: "SAPPHIRE PRINCESS ", title: "Princess Cruises ", date: "December 15."},
            {destination: "OCEANIA MARINA ", title: "Oceania Cruises ", date: "December 19."},
            {destination: "CELEBRITY ECLIPSE ", title: "Celebrity Cruises ", date: "December 20."},
            {destination: "SEVEN SEAS SPLENDOR ", title: "Regent Seven Seas ", date: "December 21."},
            {destination: "SILVER NOVA ", title: "Silver Sea ", date: "January 17, 2026."},
            {destination: "NORWEGIAN SUN ", title: "Norwegian Cruise ", date: "January 17, 2026."},
            {destination: "SEABOURN QUEST ", title: "Seabourn ", date: "January 18, 2026."},
            {destination: "SERENADE OF THE SEAS ", title: "Royal Caribbean ", date: "January 28, 2026."},
            {destination: "NORWEGIAN SUN ", title: "Norwegian Cruise ", date: "February 26, 2026."}
    ],
    extraTours: [{
        id: 'tambo-colorado',
        ...
        media: ['https://res.cloudinary.com/dvv4qgnka/image/upload/v1578270816/SAS/tour-tambo-colorado-01.jpg', 'https://res.cloudinary.com/dvv4qgnka/image/upload/v1578271256/SAS/tour-tambo-colorado-02.jpg'],
        price: {
            standard: {
                amount: 95
            }
        ...
        media: ['https://res.cloudinary.com/dvv4qgnka/image/upload/v1579059525/SAS/tour-nazca-line-01.jpg', 'https://res.cloudinary.com/dvv4qgnka/image/upload/v1579059525/SAS/tour-nazca-line-02.jpg'],
        price: {
            standard: {
                amount: 380
            }
