...
exports.default = {
	title: 'Las Lineas de Nazca y la Costa Sur de Perú',
	subtitle: 'La costa sur de Per\xFA es la cuna de la civilizaci\xF3n Inca. Es de enigmas intrigantes estimula la curiosidad de incluso de la gente m\xE1s pragm\xE1tico. Extra\xF1os geoglifos envian mensajes a los cielos y las antiguas ruinas y restos de origen dudoso adornan el paisaje de dunas y monta\xF1as. Mientras sus hermosas costas desborda de la vida marina - todos impregnados de la cultura antigua.',
	...
	packages: [{
		...
		additionalData: {
			include: ['Todos los traslados y transporte', 'Todos los tasas y entradas', 'Alojamiento', 'Desayuno'],
		...
		itenerary: [{
			...
			title: 'Día 2',
			data: [['7:45am', 'Traslado desde su hotel al muelle turistico de Paracas'], ['8:00am - 10:00am', 'Excursion a las Islas Ballestas (2 horas) Incluye asientos de primera clase (2 asientos por persona, guia bilingue.'], ['10:45am - 11:45pm', 'Check out y traslado a Huacachina (Oasis de America) en bus'], ['12:00am - 1:00pm', 'Paseo en tubulares y sandboard. full adrenalina (60 minutos)'], ['1:00pm - 3:30pm', 'Tiempo libre para almorzar y caminar alrededor del Oasis'], ['2:00pm', 'opcional: 1ra partida a Cruz del sur con destino Lima(5 horas, incluye snack)'], ['3:30pm - 4:45pm', 'Tour del Pisco y vinos (75 minutos incluye traslado a estacion de bus Cruz del Sur Ica)'], ['5.45pm', '2 salida a Lima en Cruz del Sur Primera Clase (5 horas snack incluido)']]
		}]
	}, {
		id: 'updgrade-to-vip',
		title: 'Servicio Mejorado VIP',
		shortTitle: 'Servicio Mejorado VIP',
		subtitle: 'Nuestro servicio VIP, incluye servicios de alta calidad, hotel 5 estrellas el nuevo Aranwa de Paracas.',
		url_image: 'images/package/aranwa_paracas_01_p.jpg',
		description: 'El Aranwa, uno de los hoteles de cinco estrellas en Paracas incluye la funci\xF3n de 115 habitaciones, 2 piscinas, un sal\xF3n en el muelle y un gran restaurante y todas las dem\xE1s comodidades que usted debe esperar de un hotel de esta categor\xEDa como en la habitaci\xF3n tel\xE9fono, secador de pelo, mini servicio de bar, caja de seguridad electr\xF3nica, ba\xF1o con ba\xF1era, televisi\xF3n por cable, habitaciones y lavander\xEDa.\n\t\t\t\tTransporte VIP privado (en coche o van en funci\xF3n del tama\xF1o de su grupo) desde y hacia Lima y los diferentes destinos de este paquete tur\xEDstico en el estilo, confort y una mayor velocidad de transporte en autob\xFAs que le permitir\xE1 relajarse y disfrutar de m\xE1s tiempo de ocio en sus vacaciones preciosas.',
		additionalData: {
			include: ['Incluye todo de nuestro tour estándar', 'VIP Hotel Aranwa 5 estrellas', 'Transportation privada', 'Todos los tours y servicios mejorada VIP cuando esta disponible'],
			price: {
				currency: '$',
				ammount: 886.00,
				data: ['Minimo 2 personas']
		...
		itenerary: [{
			...
			title: 'Día 2',
			data: [['7:45am', 'Traslado al muelle turistico del lobby del Hotel Aranwa'], ['8:00am - 10:00am', 'Excursion a las Islas Ballestas (2 horas) Incluye asientos de primera clase (2 asientos reservado por persona. Guia Bilingue'], ['11:00am - 12:00pm', 'Check out y traslado privado a Ica'], ['12:00am - 1:00pm', 'Visita Guiada a las bodegas de Pisco y Vino, traslado a Huacachina. (60 minutos)'], ['1:00pm - 3:30pm', 'Tiempo libre para almorzar y caminar alrededor del Oasis'], ['3:30pm - 5:00pm', 'Tours en arenero y sandboard en privado(90 minutos)'], ['5.00pm - 9:00pm', 'traslado privado a lima Hotel o Aeropuerto (4 horas)']]
		}]
	}]
};
