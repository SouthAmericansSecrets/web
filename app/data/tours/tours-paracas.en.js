		...
		tours:[
			...
			},
			{
				...
				additionalData: {
					include: [
						...
						'VIP seating (2 seats per person)',
					],
					notInclude: [
					],
					duration: {
			...
			},
			{
				...
				additionalData: {
					include: [
						'29 Pax. capacity',
						'Includes all benefits of Private tour',
						'Professional help designing a route plan and itinerary',
						'We expedite your reserve permissions to special islands'
					],
					notInclude: [
					],
					duration: {
...
Our guided program begins once your guide picks you up from your hotel. Our airliner are Caravans carrying a capacity of 12 passengers. Our pilots speak English and explain each mysterious figure etched on the land below.`,
				additionalData: {
					include: [
						'Pick up from your hotel in Paracas',
						'Airport taxes',
						'Transfer to the Pisco international airport',
						'Assistance by a local guide',
					...
					notes: [
						'Please inform us if any guests in your party weigh more than 100 kg',
						'Bring your passport (not a copy)'
					],
					duration: {
						subtitle:'1 hr 45 min',
						data:[
							'From 07:00 am to 4:00 pm Monday through Sunday(flights are subject to weather conditions & air traffic)'
						]
					},
					recommendations: [
						'Wear light clothing, especially in summer',
					],
					price: {
						currency:'$',
						ammount:280,
...
<b>Bike Tour w/ Van Support</b><br/> Let us bring you and your bicycle to the best spot in the reserve. From there enjoy freedom on two wheels with the wind on your back. Includes transport, maps, routes, helmet, tools and emergency communication (optional).`,
				...
				},*/
				{
						...
						additionalData:
						{
								include:[
									'Sandboarding',
									'Dune buggy trip over giant dunes',
									'Entrance fees.',
								],
								notInclude:[
										'Extras & gratuities.'
...
Discover the bay with a partner in a 2-seater kayak - follow your whim and you're on your way to new experiences! We can help you plan a route and deliver you and your equipment to customized launch and landing spots.`,
						...
						additionalData:
						{
								include:[
									'Life Jacket',
									'Kayak and paddle(s)',
									'Kayak deliver to launch spot',
									'Kayak pickup at landing spot',
									'Instructions',
								],
								notInclude:[
									'Extras & gratuities.',
									'Kayak pickup within the reserve',
								],
								 duration:{
										subtitle:'2 hours',
										data:[
								...
								recommendations:[
									...
									'Only strong swimmers should consider this sport',
								],
								price:{
										currency:'$',
										ammount:20,
