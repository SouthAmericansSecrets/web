...
exports.default = {
	...
	tours: [{
		...
		additionalData: {
			include: ['40 Pax. capacity', 'Transfer to Paracas dock', 'Boat transport', 'Backup boat primed & ready', 'Professional Yachtsman and mate', 'English speaking guide', 'Reserve and dock entrance fees pre-paid (over $6 US)'],
		...
		additionalData: {
			...
			duration: {
				subtitle: 'Varies',
				data: ['Durations of private excursions vary depending on activities selected (full day and half day activities available)']
			},
			recommendations: ['Our guides recommend, Pickup when you first disembark in order to see wildlife in action and avoid bad weather in the afternoon.'],
			price: {
				data: ['prices for private excursions vary depending on activities selected and number of participants']
			}
		}
	}, {
		...
		additionalData: {
			...
			recommendations: ['*This tour combines perfectly with any of our numerous additional shore excursion activities  available to guests such as: Nazca lines flight, Tambo Colorado ( Ica ancient site), or Pisco distillery and vineyard valley tour.'],
			price: {
		...
		gallery: ['images/gallery/ballestas_13_t.jpg', 'images/gallery/ballestas_02_t.jpg', 'images/gallery/ballestas_03_t.jpg', 'images/gallery/ballestas_04_t.jpg', 'images/gallery/ballestas_15_t.jpg'],
		additionalData: {
			include: ['Limited to 18 guests', 'Double seating', 'All entrance fees', 'Harbor tax', 'Personal insurance in case of injuries', 'Pickup and dropoff directly from port/harbor', 'All transportation', 'English speaking guide'],
		...
		additionalData: {
			include: ['Pick up from your hotel in Paracas.', 'Private transportation.', 'Professional English guide', 'Entrance fees.'],
